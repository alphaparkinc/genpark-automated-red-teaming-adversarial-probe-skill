# genpark-automated-red-teaming-adversarial-probe-skill
...
**genpark-automated-red-teaming-adversarial-probe-skill** is a deterministic, zero-dependency Python skill engineered for autonomous AI agents, multi-agent frameworks (Claude Desktop, Cursor, AutoGPT, CrewAI), and enterprise pipelines.

> **Executive Capability**: Automated red teaming adversarial safety probe & jailbreak fuzzer
...
result = client.run_adversarial_safety_probe()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-automated-red-teaming-adversarial-probe-skill": {
      "command": "python",
      "args": ["/path/to/genpark-automated-red-teaming-adversarial-probe-skill/mcp_server.py"]
    }
  }
}
```
